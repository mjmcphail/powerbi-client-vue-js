  ...
  <div class="container">
    ...
    <div class="controls">
      ...
      <template v-else>
        ...
        <button @click="embedReport()" class="embed-report">
          Embed Report
        </button>
      </template>
    ...
    <div class="footer">
      ...
      <p>
        Find the<a
          href="https://github.com/microsoft/powerbi-client-vue-js"
          target="_blank"
          rel="noreferrer noopener"
          >source code</a
        >
    ...
    > {
      ...
      try {
        const response: IHttpPostMessageResponse<void> =
          await this.report.updateSettings(settings);
